...
JING.Globe = function(container, opts) {
  opts = opts || {};
  
  var colorFn = opts.colorFn || function(x) {
    var c = new THREE.Color();
    c.setHSL( ( 1.6 - ( x * 0.5 ) ), 1.0, 0.5 );
    return c;
  };
  var imgDir = opts.imgDir || '../assets/texture/';
  ...
  function init() {
    ...
    uniforms['texture'].value = THREE.ImageUtils.loadTexture(imgDir+'earthDiffuse.png');
